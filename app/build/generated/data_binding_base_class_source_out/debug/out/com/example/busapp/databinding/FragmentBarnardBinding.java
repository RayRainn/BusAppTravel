...
public final class FragmentBarnardBinding implements ViewBinding {
  @NonNull
  private final ConstraintLayout rootView;

  @NonNull
  public final ImageButton barnback;
  ...
  private FragmentBarnardBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton barnback,
      @NonNull ImageView imageView12, @NonNull ImageView imageView13,
      @NonNull ImageView imageView15, @NonNull ImageView imageView16,
      @NonNull ImageView imageView21, @NonNull ImageView imageView7, @NonNull TextView textView11,
  ...
  @NonNull
  public static FragmentBarnardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentBarnardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_barnard, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentBarnardBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.barnback;
      ImageButton barnback = ViewBindings.findChildViewById(rootView, id);
      if (barnback == null) {
        break missingId;
      }
      ...
      return new FragmentBarnardBinding((ConstraintLayout) rootView, barnback, imageView12,
          imageView13, imageView15, imageView16, imageView21, imageView7, textView11, textView14,
