...
//public class castledesigntest extends AppCompatActivity {

    /*RecyclerView recyclerView;
    castlesadapter castlesadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        castledelist.add(new castlesinfo("Bamburgh Castle", R.drawable.ac130));
        castledelist.add(new castlesinfo("Alnwick Castle", R.drawable.au4));
        castledelist.add(new castlesinfo("Auckland Castle", R.drawable.bb3));
